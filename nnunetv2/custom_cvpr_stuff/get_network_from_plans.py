...
def get_network_from_plans(arch_class_name, arch_kwargs, arch_kwargs_req_import, input_channels, output_channels,
    ...
    if nw_class is None:
        ...
        nw_class = recursive_find_python_class(join(nnunetv2.__path__[0], "custom_cvpr_stuff", "dynamic_network_architectures", "architectures"),
                                               network_class.split(".")[-1],
                                               'nnunetv2.custom_cvpr_stuff.dynamic_network_architectures.architectures')
